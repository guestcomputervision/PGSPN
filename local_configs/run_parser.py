...
class MainParser():
    ...
    def __init__(self):
        ...
        self.parser = argparse.ArgumentParser(description= "This is Initial Option for..."
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--world_size', type=int, default=1, help='number of nodes for distributed training')
